    ...
    return (
        <Box sx={{ display: 'flex' }}>
            ...
            <AppBar position="fixed" open={open}>
                <Toolbar>
                    ...
                    <IconButton
                        ...
                        color="inherit"
                        onClick={handleMenuOpen} // Open menu on icon button click
                    >
                        <FaRegUser />
                    </IconButton>
                    <Menu
            ...
            <Drawer variant="permanent" open={open}>
                ...
                <Divider />
                <List>
                    <ListItem disablePadding sx={{ display: 'block' }} onClick={() => navigate("/user/courses")}>
                        <ListItemButton
                            sx={{
                                minHeight: 48,
                    ...
                    <ListItem disablePadding sx={{ display: 'block' }} onClick={() => navigate("/user/my_courses")}>
                        <ListItemButton
                            sx={{
                                minHeight: 48,
                                justifyContent: open ? 'initial' : 'center',
