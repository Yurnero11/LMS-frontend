...
import { MdDashboard, MdOutlinePlayLesson, MdAddBox } from "react-icons/md";
        ...
        <Box sx={{ display: 'flex' }}>
            ...
            <Drawer variant="permanent" open={open}>
                ...
                <List>
                    ...
                    <ListItem disablePadding sx={{ display: 'block' }} onClick={() => navigate("/admin/courses")}>
                        <ListItemButton
                            sx={{
                                minHeight: 48,
                                justifyContent: open ? 'initial' : 'center',
                    ...
                    <ListItem disablePadding sx={{ display: 'block' }} onClick={() => navigate("/admin/materials")}>
                        <ListItemButton
                            sx={{
                                minHeight: 48,
                                justifyContent: open ? 'initial' : 'center',
                    ...
                    <ListItem disablePadding sx={{ display: 'block' }} onClick={() => navigate("/admin/requests")}>
                        <ListItemButton
                            sx={{
                                minHeight: 48,
                                justifyContent: open ? 'initial' : 'center',
